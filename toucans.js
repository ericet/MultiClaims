const chainId = 42161;
const contractAddress = "0xe24b979A8b71218461A0C0F28Ab7D1BbED4375b5";//main net
const etherscanUrl = "https://arbiscan.io/tx";//main net
let provider = null;
...
window.onload = () => {
  ...
  const failedConnectWallet = () => {
    document.getElementById("button").innerHTML = "Error Network, switch to Arbitrum Network";
  };
